...
//
// Both arrays are generated by main.py and emitted to fence_params.svh.
  // fence_params.svh declares LEVEL_BITS, MAX_FENCES, FENCE_MASKS, FENCE_REQ_LEVELS_PACKED.
  `include "fence_params.svh"
