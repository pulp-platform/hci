...
def unfold_raw_txt(folder_path_raw,folder_path_processed,IW,DATA_WIDTH,ADD_WIDTH):
...
def pad_txt_files(folder_path,IW,DATA_WIDTH,ADD_WIDTH):
        ...
        if padding_needed > 0:
            ...
            with open(file_path, 'a', encoding = 'ascii') as f:
                if "log" in file:
                    ...
                    for _ in range(padding_needed):
                        f.write("0 " + '0'*IW + " " + '0' + " " + '0'*int(4*DATA_WIDTH) + " " + '0'*ADD_WIDTH + "\n") 
