...
setup_bandwidth: 
	...
	sed -i 's/^PRIORITY_CHECK_STALL.*$$/PRIORITY_CHECK_MODE_ONE=0/' $(CONFIG_FILE_SIM)
	sed -i 's/^PRIORITY_CHECK_NO_STALL.*$$/PRIORITY_CHECK_MODE_ZERO=0/' $(CONFIG_FILE_SIM)
...
setup_arbiter_stall:
	sed -i 's/^MAX_CYCLE_OFFSET.*$$/MAX_CYCLE_OFFSET=7/' $(CONFIG_FILE_SIM)
	sed -i 's/^RANDOM_GNT.*$$/RANDOM_GNT=1/' $(CONFIG_FILE_SIM)
	sed -i 's/^PRIORITY_CHECK_STALL.*$$/PRIORITY_CHECK_MODE_ONE=1/' $(CONFIG_FILE_SIM)
	sed -i 's/^PRIORITY_CHECK_NO_STALL.*$$/PRIORITY_CHECK_MODE_ZERO=0/' $(CONFIG_FILE_SIM)
...
setup_arbiter_no_stall:
	...
	sed -i 's/^RANDOM_GNT.*$$/RANDOM_GNT=1/' $(CONFIG_FILE_SIM)
	sed -i 's/^PRIORITY_CHECK_STALL.*$$/PRIORITY_CHECK_MODE_ONE=0/' $(CONFIG_FILE_SIM)
	sed -i 's/^PRIORITY_CHECK_NO_STALL.*$$/PRIORITY_CHECK_MODE_ZERO=1/' $(CONFIG_FILE_SIM)
