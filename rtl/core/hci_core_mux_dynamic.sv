...
(
  ...
  logic [NB_IN_CHAN-1:0][hci_package::iomsb(UW):0]             in_user;
  ...
  logic [NB_IN_CHAN-1:0][hci_package::iomsb(UW):0]             in_r_user;
  ...
  logic [NB_OUT_CHAN-1:0][hci_package::iomsb(UW):0]            out_user;
  ...
  logic [NB_OUT_CHAN-1:0][hci_package::iomsb(UW):0]            out_r_user;
